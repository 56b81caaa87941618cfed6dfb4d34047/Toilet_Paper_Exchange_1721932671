...
Vue.component("quoty_faq_accordion_component_1721932672", {
    template: `
    <section class="py-8 bg-white pl-4">
        <h2 class="text-lg font-semibold mb-5">Frequently Asked Questions About TP Traders</h2>
        <!-- Accordion -->
        <div class="space-y-3">
            <!-- Accordion item -->
    ...
    data() {
        return {
            terms: [
                { title: "What is TP Traders?", description: "TP Traders is an online marketplace for buying, selling and trading toilet paper rolls. In times of shortage, find the TP you need here.", expanded: false },
                { title: "How does it work?", description: "Create an account, list your toilet paper inventory, and set your desired prices. Browse listings from other sellers and make offers or purchase directly.", expanded: false },
                { title: "Is it legal?", description: "Yes, TP Traders operates within all applicable laws for legal trading of goods between individuals.", expanded: false },
                { title: "What payment methods are accepted?", description: "We accept secure payment via major credit cards, PayPal, and cryptocurrency for maximum flexibility.", expanded: false },
            ],
        };
    },
    methods: {
